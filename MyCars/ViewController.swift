...
//  MyCars
//
//  Created by Чистяков Василий Александрович on 05.06.2021.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var segmentedControl: UISegmentedControl! {
        didSet {
            ...
            let blackTitelTextAtributes = [NSAttributedString.Key.foregroundColor: UIColor.black]
            
            UISegmentedControl.appearance().setTitleTextAttributes(whiteTitleTextAttributes, for: .normal)
            UISegmentedControl.appearance().setTitleTextAttributes(blackTitelTextAtributes, for: .selected )
        }
    }
    ...
    private func update(rating: Double) {
        ...
        do {
            ...
            let allertController = UIAlertController(title: "Wrong value", message: "Wrong input", preferredStyle: .alert)
